...
_grp1 = [_position, civilian, [_rUnit1, _rUnit2, _rUnit3, _rUnit4, _rUnit5, _rUnit6],0] call BIS_fnc_spawnGroup;
sleep 2;
_grp2 = [_position, east, [pop, pop, pop, pop, pop, pop, carrier],0] call BIS_fnc_spawnGroup;
sleep 1;
