...
sleep 0.25;
_grp4 = [_position, resistance, ["LM_OPCAN_CPD_Officer_M45","LM_OPCAN_CPD_Officer"],0] call BIS_fnc_spawnGroup;
[_grp4, _position, 250, 3, nil, false, true] spawn lambs_wp_fnc_taskPatrol;
sleep 0.25;
