...
_wpt1 = grp1 addWaypoint [getMarkerPos "a3M11",5];
_wpt1 setWaypointBehaviour "CARELESS";
_wpt1 setWaypointCombatMode "BLUE";    
_wpt1 setWaypointType "MOVE";

_wpt1a = grp1 addWaypoint [getMarkerPos "Banshee10_marker",5];
...
_wpt2 = grp2 addWaypoint [getMarkerPos "a3M11",5];
_wpt2 setWaypointBehaviour "CARELESS";
_wpt2 setWaypointCombatMode "BLUE";         
_wpt2 setWaypointType "MOVE";
    
_wpt2a = grp2 addWaypoint [getMarkerPos "Banshee10_marker",5];
...
_wpt3 = grp3 addWaypoint [getMarkerPos "a3M11",5];
_wpt3 setWaypointBehaviour "CARELESS";
_wpt3 setWaypointCombatMode "BLUE";         
_wpt3 setWaypointType "MOVE";
    
_wpt3a = grp3 addWaypoint [getMarkerPos "Banshee10_marker",5];
...
grp4 = [getMarkerPos "Banshee3_Spawn", EAST, ["OPTRE_FC_Type26B_Banshee"],0] call BIS_fnc_spawnGroup;          
_wpt4 = grp4 addWaypoint [getMarkerPos "a3M11",5];
_wpt4 setWaypointBehaviour "CARELESS";
_wpt4 setWaypointCombatMode "BLUE";         
_wpt4 setWaypointType "MOVE";
    
_wpt4a = grp4 addWaypoint [getMarkerPos "Banshee10_marker",5];
...
_wp2 = _crew1 addWaypoint [(getmarkerpos "FLZ"), 0];
...
_wp1a = _mygroup addWaypoint [getmarkerpos "FLZ_1", 0];
_wp1a setWaypointType "MOVE";
_wp1a setWaypointBehaviour "CARELESS";
_wp1a setWaypointCombatMode "BLUE";

_wp1b = _mygroup addWaypoint [getmarkerpos "FRP_1", 0];
_wp1b setWaypointType "GUARD";
_wp1b setWaypointBehaviour "AWARE";
_wp1b setWaypointCombatMode "YELLOW";
_wp1b setWaypointSpeed "NORMAL";
...
_wp2 = _crew1 addWaypoint [(getmarkerpos "FLZ_1"), 0];
_wp2 setWaypointType "TR UNLOAD";
_wp2 setWaypointBehaviour "CARELESS";
_wp2 setWaypointCombatMode "YELLOW";
_wp2 setWaypointSpeed "NORMAL";
...
_mygroup = [getmarkerpos "spawner", EAST, [_rUnit1, _rUnit2, _rUnit3, _rUnit4, _rUnit5, _rUnit6, _rUnit7, _rUnit8],[],[],[],[],[],180] call BIS_fnc_spawnGroup;
_wp1a = _mygroup addWaypoint [getmarkerpos "FLZ_2", 0];
_wp1a setWaypointType "MOVE";
_wp1a setWaypointBehaviour "CARELESS";
_wp1a setWaypointCombatMode "RED";

_wp1b = _mygroup addWaypoint [getmarkerpos "FRP_2", 0];
_wp1b setWaypointType "GUARD";
_wp1b setWaypointBehaviour "AWARE";
_wp1b setWaypointCombatMode "YELLOW";
_wp1b setWaypointSpeed "NORMAL";
...
_wp2 = _crew1 addWaypoint [(getmarkerpos "FLZ_2"), 0];
_wp2 setWaypointType "TR UNLOAD";
_wp2 setWaypointBehaviour "CARELESS";
_wp2 setWaypointCombatMode "YELLOW";
_wp2 setWaypointSpeed "NORMAL";
...
_mygroup = [getmarkerpos "spawner_1", EAST, [_rUnit1, _rUnit2, _rUnit3, _rUnit4, _rUnit5, _rUnit6, _rUnit7, _rUnit8],[],[],[],[],[],180] call BIS_fnc_spawnGroup;
_wp1a = _mygroup addWaypoint [getmarkerpos "FLZ_3", 0];
_wp1a setWaypointType "MOVE";
_wp1a setWaypointBehaviour "CARELESS";
_wp1a setWaypointCombatMode "RED";

_wp1b = _mygroup addWaypoint [getmarkerpos "FRP_3", 0];
_wp1b setWaypointType "GUARD";
_wp1b setWaypointBehaviour "AWARE";
_wp1b setWaypointCombatMode "YELLOW";
_wp1b setWaypointSpeed "NORMAL";
...
_wp2 = _crew1 addWaypoint [(getmarkerpos "FLZ_3"), 0];
_wp2 setWaypointType "TR UNLOAD";
_wp2 setWaypointBehaviour "CARELESS";
_wp2 setWaypointCombatMode "YELLOW";
_wp2 setWaypointSpeed "NORMAL";
...
_crew1 = creategroup EAST;
_airframe1 = [getMarkerPos "a3M11", 315, "OPTRE_FC_Wraith", _crew1] call BIS_fnc_spawnVehicle;
_wp1 = _crew1 addWaypoint [(getmarkerpos "a3M13"), 0];
