...
_position1 = getMarkerPos "pspawn_1";
sleep 0.25;

_grp3 = [_position1, resistance, ["LM_OPCAN_CPD_TL","LM_OPCAN_CPD_TL","LM_OPCAN_CPD_TL","LM_OPCAN_CPD_TL"],0] call BIS_fnc_spawnGroup;
[_grp3, _position1, 250, 3, nil, false, true] spawn lambs_wp_fnc_taskPatrol;
sleep 0.25;

_grp4 = [_position1, resistance, ["LM_OPCAN_CPD_Officer_M45","LM_OPCAN_CPD_Officer"],0] call BIS_fnc_spawnGroup;
