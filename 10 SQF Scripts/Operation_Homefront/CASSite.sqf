...
_wpt1 = grp1 addWaypoint [getMarkerPos "Banshee7_marker",5];
_wpt1 setWaypointBehaviour "CARELESS";
_wpt1 setWaypointCombatMode "BLUE";    
_wpt1 setWaypointType "MOVE";

_wpt1a = grp1 addWaypoint [getMarkerPos "Banshee8_marker",5];
...
_wpt2 = grp2 addWaypoint [getMarkerPos "Banshee7_marker",5];
_wpt2 setWaypointBehaviour "CARELESS";
_wpt2 setWaypointCombatMode "BLUE";         
_wpt2 setWaypointType "MOVE";
    
_wpt2a = grp2 addWaypoint [getMarkerPos "Banshee8_marker",5];
...
_wpt3 = grp3 addWaypoint [getMarkerPos "Banshee7_marker",5];
_wpt3 setWaypointBehaviour "CARELESS";
_wpt3 setWaypointCombatMode "BLUE";         
_wpt3 setWaypointType "MOVE";
    
_wpt3a = grp3 addWaypoint [getMarkerPos "Banshee8_marker",5];
...
_wpt4 = grp4 addWaypoint [getMarkerPos "Banshee7_marker",5];
_wpt4 setWaypointBehaviour "CARELESS";
_wpt4 setWaypointCombatMode "BLUE";         
_wpt4 setWaypointType "MOVE";
    
_wpt4a = grp4 addWaypoint [getMarkerPos "Banshee8_marker",5];
...
_aircraft1 setVehicleVarName "Spirit_12";
chalk1 = _aircraft1;
publicVariable "Spirit_12";
...
_wp2 = _crew1 addWaypoint [(getmarkerpos "a3M8"), 0];
...
_aircraft1 = _airframe1 select 0;
_aircraft1 setVehicleVarName "chalk2";
chalk1 = _aircraft1;
publicVariable "chalk2";
...
_wp1 = _crew1 addWaypoint [(getmarkerpos "Banshee8_marker"), 0];
_wp1 setWaypointType "MOVE";
...
_crew1 = creategroup EAST;
_airframe1 = [getMarkerPos "a3M11", 315, "OPTRE_FC_Wraith", _crew1] call BIS_fnc_spawnVehicle;
_wp1 = _crew1 addWaypoint [(getmarkerpos "Banshee7_marker"), 0];
_wp1 setWaypointType "MOVE";
_wp1 setWaypointCombatMode "YELLOW";
_wp1 setWaypointSpeed "NORMAL";

_mygroup = [getmarkerpos "a3M8", EAST, ["OPTRE_FC_Elite_Minor","OPTRE_FC_Elite_Minor2","OPTRE_Jackal_F","OPTRE_Jackal_F","OPTRE_Jackal_F","OPTRE_Jackal_F","OPTRE_FC_Elite_MinorAT","OPTRE_FC_Elite_MinorAA"],[],[],[],[],[],180] call BIS_fnc_spawnGroup;
_wp1a = _mygroup addWaypoint [getmarkerpos "a3M9", 0];
_wp1b setWaypointType "GUARD";
_wp1b setWaypointBehaviour "AWARE";
_wp1b setWaypointCombatMode "YELLOW";
_wp1b setWaypointSpeed "NORMAL";
